...
const iconLinkClass =
  "inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-md border border-[#D5D9C9] bg-white text-[#14201B] transition hover:bg-[#EEF0E5] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1F8A5B]";

const menuLinkClass =
  "relative inline-flex min-h-11 items-center justify-center gap-2 rounded-md border border-[#D5D9C9] bg-[#F7F7F2] px-3 text-sm font-medium focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1F8A5B]";
    ...
    <header className="b2b-header sticky top-0 z-30 border-b border-[#D5D9C9] bg-[#F7F7F2]/95 text-[#14201B] backdrop-blur">
      <div className="mx-auto flex min-h-16 max-w-7xl items-center justify-between gap-3 px-4">
        <Link
          ...
          className="flex min-h-11 shrink-0 items-center gap-2 rounded-md font-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1F8A5B]"
        >
        ...
        <nav className="hidden shrink-0 items-center gap-1 xl:flex" aria-label="ناوبری عمده">
          {navItems.map((item) => {
            const isActive =
            ...
            return (
              <Link
                ...
                className={`inline-flex min-h-11 items-center whitespace-nowrap rounded-md px-3 py-2 text-sm transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#1F8A5B] ${
        ...
        <SmartSearch
          channel="wholesale"
          className="hidden min-w-0 flex-1 md:block lg:max-w-lg xl:max-w-2xl"
        />
        ...
        <div className="flex shrink-0 items-center gap-2">
          <Link
            ...
            className={`${iconLinkClass} !hidden xl:!inline-flex`}
          >
          ...
          <Link
            href="/b2b/catalog"
            className="hidden min-h-11 items-center justify-center gap-2 whitespace-nowrap rounded-md border border-[#1F8A5B] bg-[#1F8A5B] px-3 text-sm text-white hover:bg-[#176D48] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1F8A5B] xl:inline-flex"
          >
          ...
          <button
            ...
            className={`${iconLinkClass} xl:!hidden`}
        ...
        >
          ...
          <nav aria-label="منوی موبایل عمده" className="mx-auto grid max-w-7xl gap-2 px-4 py-4">
            ...
            <div className="mt-2 grid grid-cols-2 gap-2 border-t border-[#D5D9C9] pt-3">
              <Link href={cartHref} className={menuLinkClass}>
                <ShoppingCart size={18} aria-hidden="true" />
                سبد عمده
                {cartCount > 0 ? (
              ...
              <Link href={accountHref} className={menuLinkClass}>
                <UserRound size={18} aria-hidden="true" />
                {accountLabel}
              </Link>
            </div>
