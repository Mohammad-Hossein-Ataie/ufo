...
import { localBusinessJsonLd } from "@ufo/seo";
    ...
    <main className="mx-auto max-w-5xl px-4 py-10">
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-2">
        ...
        <section className="rounded-md border border-[#22303D] bg-[#141A22] p-5">
          ...
          <p className="mt-3 leading-8 text-[#D9E2EC]">
            بعد از ثبت سفارش، دریافت حضوری با هماهنگی پشتیبانی فعال می‌شود. موجودی کالا قبل از مراجعه رزرو می‌شود.
          </p>
          <Alert title="مسیر دسترسی" tone="info">
            برای جلوگیری از doorway page، همین صفحه تنها صفحه محلی فروشگاه تهران است و اطلاعات آن با schema یکسان نگه داشته می‌شود.
          </Alert>
        </section>
      </div>
      <section className="mt-6 rounded-md border border-[#22303D] bg-[#0D1117] p-5">
        ...
        <div className="mt-4 grid gap-4">
          <article>
            <h3 className="font-bold">آیا سفارش حضوری بدون ثبت آنلاین ممکن است؟</h3>
            <p className="mt-1 text-[#9BA7B4]">برای رزرو موجودی، ثبت سفارش آنلاین پیشنهاد می‌شود.</p>
          </article>
          <article>
            <h3 className="font-bold">آیا پیک تهران فعال است؟</h3>
            <p className="mt-1 text-[#9BA7B4]">بله، برای شهر تهران و پس از تایید پرداخت قابل انتخاب است.</p>
          </article>
        </div>
      </section>
    </main>
